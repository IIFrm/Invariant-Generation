...
the green area is the correct invariant; 
the red area is the learnt invariant; 
the green nodes represent the samples inside of the invariant; 
and the red nodes stand for the samples outside of the invariant. 
...
and learn an invariant in Figure~\ref{fig:sampling:random:invariant}. 
...
the new learnt invariant moves towards the real invariant quickly. 

...
So in this step, we would like to sample a state with a high possibility if it is important for the learning afterwards.
Then we execute program from these samples to gather more data and label them according to the satisfiability of $Pre$ and $Post$.

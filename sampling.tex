...
on the borders of the most recently learnt invariant. 
...
It is a sampling technique that helps $\textsc{Zilu}$ 
to amend the invariant candidiate at a fast pace.
...
It is obvious that, due to the limited number of samples we have (which is often referred to as labeled samples in the machine learning community), 

...
which will subsequently help us to identify the candidate invariant separating $\mathit{Negative}$ from the rest: $\mathit{x - y \leq 16}$ and prove the Hoare triple.

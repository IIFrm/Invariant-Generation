...
\begin{align}
    ...
    & \mathit{Positive}(\mathit{Sample}) & = & \{s | s \models \mathit{Pre} \land s \Rightarrow s' \land s' \models \mathit{Post}\}~~~~~~ \\

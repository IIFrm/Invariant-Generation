...
var2names(p(pc(_), data(V3, V4, V2, V1)), [(V3, 'tmp'), (V4, 'k'), (V2, 'j'), (V1, 'i')]).
...
r(p(pc(main-2-6), data(V3, V4, V2, V1)), p(pc(main-4-6), data(V3p, V4p, V2p, V1p)), [(V2 = 0)], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 2). % j == 0
...
r(p(pc(main-2-6), data(V3, V4, V2, V1)), p(pc(main-5-6), data(V3p, V4p, V2p, V1p)), [(V2 +1 =< 0)], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 4). % j < 0
stmtsrc(4, 'assume(j < 0);').
transition_access( 4, [_, _, r, _] ).
r(p(pc(main-2-6), data(V3, V4, V2, V1)), p(pc(main-5-6), data(V3p, V4p, V2p, V1p)), [(V2 >= 1+ 0)], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 5). % j > 0
...
r(p(pc(main-9-7), data(V3, V4, V2, V1)), p(pc(main-10-8), data(V3p, V4p, V2p, V1p)), [(V1 =< V4)], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 13). % i <= k
stmtsrc(13, 'assume(i <= k);').
transition_access( 13, [_, r, _, r] ).
r(p(pc(main-9-7), data(V3, V4, V2, V1)), p(pc(main-11-7), data(V3p, V4p, V2p, V1p)), [(V1 >= 1+ V4)], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 14). % i > k
stmtsrc(14, 'assume(i > k);').
...
r(p(pc(main-12-0), data(V3, V4, V2, V1)), p(pc(main-6-7), data(V3p, V4p, V2p, V1p)), [], [V3p = V3, V4p = V4, V2p = (V2 + 1), V1p = V1], 16). % j := j + 1
stmtsrc(16, 'j=j + 1;').
...
r(p(pc(main-7-10), data(V3, V4, V2, V1)), p(pc(main-err-0), data(V3p, V4p, V2p, V1p)), [(V2 +1 =< V1)], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 18). % j < i
stmtsrc(18, 'assume(j < i);').
transition_access( 18, [_, _, r, r] ).
r(p(pc(main-7-10), data(V3, V4, V2, V1)), p(pc(main-err-0), data(V3p, V4p, V2p, V1p)), [(V2 >= 1+ V1)], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 19). % j > i
stmtsrc(19, 'assume(j > i);').
transition_access( 19, [_, _, r, r] ).
r(p(pc(main-7-10), data(V3, V4, V2, V1)), p(pc(main-13-11), data(V3p, V4p, V2p, V1p)), [(V2 = V1)], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 20). % j == i
stmtsrc(20, 'assume(j == i);').
transition_access( 20, [_, _, r, r] ).
r(p(pc(main-13-11), data(V3, V4, V2, V1)), p(pc(main-ret-0), data(V3p, V4p, V2p, V1p)), [], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 21). % 
stmtsrc(21, 'skip;').
transition_access( 21, [_, _, _, _] ).
r(p(pc(main-11-7), data(V3, V4, V2, V1)), p(pc(main-8-0), data(V3p, V4p, V2p, V1p)), [], [V3p = V3, V4p = V4, V2p = V2, V1p = V1], 22). % 
stmtsrc(22, 'skip;').

...
r(p(pc(main-2-6), data(V4, V3, V2, V1)), p(pc(main-4-6), data(V4p, V3p, V2p, V1p)), [(V3 >= 1+ 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 2). % k > 0
...
r(p(pc(main-2-6), data(V4, V3, V2, V1)), p(pc(main-5-6), data(V4p, V3p, V2p, V1p)), [(V3 =< 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 4). % k <= 0
...
r(p(pc(main-7-10), data(V4, V3, V2, V1)), p(pc(main-err-0), data(V4p, V3p, V2p, V1p)), [(V3 =< (V2 - V1))], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 16). % k <= j - i
stmtsrc(16, 'assume(k <= j - i);').
transition_access( 16, [_, r, r, r] ).
r(p(pc(main-7-10), data(V4, V3, V2, V1)), p(pc(main-13-11), data(V4p, V3p, V2p, V1p)), [(V3 >= 1+ (V2 - V1))], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 17). % k > j - i
stmtsrc(17, 'assume(k > j - i);').
transition_access( 17, [_, r, r, r] ).

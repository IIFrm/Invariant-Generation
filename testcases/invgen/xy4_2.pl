...
cfg_exit_relation([]).
% 20 transitions
r(p(pc(main-0-5), data(V2, V1, V3)), p(pc(main-2-5), data(V2p, V1p, V3p)), [(V1 = (4 * V2))], [V2p = V2, V1p = V1, V3p = V3], 1). % x == 4 * y
stmtsrc(1, 'assume(x == 4 * y);').
...
r(p(pc(main-0-5), data(V2, V1, V3)), p(pc(main-3-5), data(V2p, V1p, V3p)), [(V1 +1 =< (4 * V2))], [V2p = V2, V1p = V1, V3p = V3], 6). % x < 4 * y
stmtsrc(6, 'assume(x < 4 * y);').
transition_access( 6, [r, r, _] ).
r(p(pc(main-0-5), data(V2, V1, V3)), p(pc(main-3-5), data(V2p, V1p, V3p)), [(V1 >= 1+ (4 * V2))], [V2p = V2, V1p = V1, V3p = V3], 7). % x > 4 * y
stmtsrc(7, 'assume(x > 4 * y);').
...
r(p(pc(main-10-7), data(V2, V1, V3)), p(pc(main-12-0), data(V2p, V1p, V3p)), [], [V2p = V2, V1p = (V1 - 4), V3p = V3], 14). % x := x - 4
stmtsrc(14, 'x=x - 4;').

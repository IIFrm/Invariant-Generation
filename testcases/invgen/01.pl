...
r(p(pc(main-2-5), data(V2, V1, V3)), p(pc(main-4-5), data(V2p, V1p, V3p)), [(V2 = 1)], [V2p = V2, V1p = V1, V3p = V3], 2). % y == 1
stmtsrc(2, 'assume(y == 1);').
...
r(p(pc(main-2-5), data(V2, V1, V3)), p(pc(main-5-5), data(V2p, V1p, V3p)), [(V2 +1 =< 1)], [V2p = V2, V1p = V1, V3p = V3], 4). % y < 1
stmtsrc(4, 'assume(y < 1);').
transition_access( 4, [r, _, _] ).
r(p(pc(main-2-5), data(V2, V1, V3)), p(pc(main-5-5), data(V2p, V1p, V3p)), [(V2 >= 1+ 1)], [V2p = V2, V1p = V1, V3p = V3], 5). % y > 1
stmtsrc(5, 'assume(y > 1);').
...
r(p(pc(main-10-0), data(V2, V1, V3)), p(pc(main-11-0), data(V2p, V1p, V3p)), [], [V2p = V1, V1p = V1, V3p = V3], 14). % y := x
stmtsrc(14, 'y=x;').
transition_access( 14, [w, r, _] ).
r(p(pc(main-11-0), data(V2, V1, V3)), p(pc(main-err-0), data(V2p, V1p, V3p)), [(V2 +1 =< 1)], [V2p = V2, V1p = V1, V3p = V3], 15). % y < 1
stmtsrc(15, 'assume(y < 1);').
transition_access( 15, [r, _, _] ).
r(p(pc(main-11-0), data(V2, V1, V3)), p(pc(main-6-6), data(V2p, V1p, V3p)), [(V2 >= 1)], [V2p = V2, V1p = V1, V3p = V3], 16). % y >= 1
stmtsrc(16, 'assume(y >= 1);').

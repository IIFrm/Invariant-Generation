...
cfg_exit_relation([]).
% 11 transitions
r(p(pc(main-0-5), data(V2, V1)), p(pc(main-1-6), data(V2p, V1p)), [(V1 +1 =< 0)], [V2p = V2, V1p = V1], 1). % x < 0
...
r(p(pc(main-4-6), data(V2, V1)), p(pc(main-5-7), data(V2p, V1p)), [(V1 +1 =< 0)], [V2p = V2, V1p = V1], 3). % x < 0
stmtsrc(3, 'assume(x < 0);').
transition_access( 3, [_, r] ).
r(p(pc(main-4-6), data(V2, V1)), p(pc(main-6-6), data(V2p, V1p)), [(V1 >= 0)], [V2p = V2, V1p = V1], 4). % x >= 0
stmtsrc(4, 'assume(x >= 0);').
transition_access( 4, [_, r] ).
r(p(pc(main-5-7), data(V2, V1)), p(pc(main-7-0), data(V2p, V1p)), [], [V2p = V2, V1p = (V1 + V2)], 5). % x := x + y
stmtsrc(5, 'x=x + y;').
transition_access( 5, [r, w] ).
r(p(pc(main-7-0), data(V2, V1)), p(pc(main-1-6), data(V2p, V1p)), [], [V2p = (V2 + 1), V1p = V1], 6). % y := y + 1
stmtsrc(6, 'y=y + 1;').
transition_access( 6, [w, _] ).
r(p(pc(main-3-0), data(V2, V1)), p(pc(main-2-10), data(V2p, V1p)), [], [V2p = V2, V1p = V1], 7). % 
stmtsrc(7, 'skip;').
transition_access( 7, [_, _] ).
r(p(pc(main-2-10), data(V2, V1)), p(pc(main-err-0), data(V2p, V1p)), [(V2 +1 =< 0)], [V2p = V2, V1p = V1], 8). % y < 0
stmtsrc(8, 'assume(y < 0);').
transition_access( 8, [r, _] ).
r(p(pc(main-2-10), data(V2, V1)), p(pc(main-8-11), data(V2p, V1p)), [(V2 >= 0)], [V2p = V2, V1p = V1], 9). % y >= 0

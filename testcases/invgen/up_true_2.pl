...
var2names(p(pc(_), data(V4, V3, V2, V1)), [(V4, 'tmp'), (V3, 'n'), (V2, 'k'), (V1, 'j')]).
...
cfg_exit_relation([]).
% 28 transitions
r(p(pc(main-0-6), data(V4, V3, V2, V1)), p(pc(main-2-6), data(V4p, V3p, V2p, V1p)), [(V1 = 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 1). % j == 0
stmtsrc(1, 'assume(j == 0);').
...
r(p(pc(main-4-6), data(V4, V3, V2, V1)), p(pc(main-6-6), data(V4p, V3p, V2p, V1p)), [(V3 >= 1+ 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 3). % n > 0
...
r(p(pc(main-4-6), data(V4, V3, V2, V1)), p(pc(main-7-6), data(V4p, V3p, V2p, V1p)), [(V3 =< 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 5). % n <= 0
...
r(p(pc(main-0-6), data(V4, V3, V2, V1)), p(pc(main-3-6), data(V4p, V3p, V2p, V1p)), [(V1 +1 =< 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 10). % j < 0
stmtsrc(10, 'assume(j < 0);').
transition_access( 10, [_, _, _, r] ).
r(p(pc(main-0-6), data(V4, V3, V2, V1)), p(pc(main-3-6), data(V4p, V3p, V2p, V1p)), [(V1 >= 1+ 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 11). % j > 0
...
r(p(pc(main-11-7), data(V4, V3, V2, V1)), p(pc(main-13-7), data(V4p, V3p, V2p, V1p)), [(V1 +1 =< V3)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 16). % j < n
stmtsrc(16, 'assume(j < n);').
transition_access( 16, [_, r, _, r] ).
r(p(pc(main-13-7), data(V4, V3, V2, V1)), p(pc(main-12-8), data(V4p, V3p, V2p, V1p)), [(V3 >= 1+ 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 17). % n > 0
stmtsrc(17, 'assume(n > 0);').
transition_access( 17, [_, r, _, _] ).
r(p(pc(main-13-7), data(V4, V3, V2, V1)), p(pc(main-15-7), data(V4p, V3p, V2p, V1p)), [(V3 =< 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 18). % n <= 0
stmtsrc(18, 'assume(n <= 0);').
transition_access( 18, [_, r, _, _] ).
r(p(pc(main-11-7), data(V4, V3, V2, V1)), p(pc(main-14-7), data(V4p, V3p, V2p, V1p)), [(V1 >= V3)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 19). % j >= n
stmtsrc(19, 'assume(j >= n);').
transition_access( 19, [_, r, _, r] ).
r(p(pc(main-12-8), data(V4, V3, V2, V1)), p(pc(main-16-0), data(V4p, V3p, V2p, V1p)), [], [V4p = V4, V3p = V3, V2p = V2, V1p = (V1 + 1)], 20). % j := j + 1
stmtsrc(20, 'j=j + 1;').
transition_access( 20, [_, _, _, w] ).
r(p(pc(main-16-0), data(V4, V3, V2, V1)), p(pc(main-8-7), data(V4p, V3p, V2p, V1p)), [], [V4p = V4, V3p = V3, V2p = (V2 - 1), V1p = V1], 21). % k := k - 1
stmtsrc(21, 'k=k - 1;').
transition_access( 21, [_, _, w, _] ).
r(p(pc(main-10-0), data(V4, V3, V2, V1)), p(pc(main-9-10), data(V4p, V3p, V2p, V1p)), [], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 22). % 
stmtsrc(22, 'skip;').
transition_access( 22, [_, _, _, _] ).
r(p(pc(main-9-10), data(V4, V3, V2, V1)), p(pc(main-err-0), data(V4p, V3p, V2p, V1p)), [(V2 +1 =< 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 23). % k < 0
stmtsrc(23, 'assume(k < 0);').
transition_access( 23, [_, _, r, _] ).
r(p(pc(main-9-10), data(V4, V3, V2, V1)), p(pc(main-err-0), data(V4p, V3p, V2p, V1p)), [(V2 >= 1+ 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 24). % k > 0
stmtsrc(24, 'assume(k > 0);').
transition_access( 24, [_, _, r, _] ).
r(p(pc(main-9-10), data(V4, V3, V2, V1)), p(pc(main-17-11), data(V4p, V3p, V2p, V1p)), [(V2 = 0)], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 25). % k == 0
...
r(p(pc(main-14-7), data(V4, V3, V2, V1)), p(pc(main-10-0), data(V4p, V3p, V2p, V1p)), [], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 27). % 
stmtsrc(27, 'skip;').
transition_access( 27, [_, _, _, _] ).
r(p(pc(main-15-7), data(V4, V3, V2, V1)), p(pc(main-10-0), data(V4p, V3p, V2p, V1p)), [], [V4p = V4, V3p = V3, V2p = V2, V1p = V1], 28). % 
stmtsrc(28, 'skip;').

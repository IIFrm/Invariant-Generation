...
r(p(pc(main-4-5), data(V1)), p(pc(main-6-5), data(V1p)), [(V1 >= 0)], [V1p = V1], 3). % x >= 0
stmtsrc(3, 'assume(x >= 0);').
transition_access( 3, [r] ).
r(p(pc(main-6-5), data(V1)), p(pc(main-5-6), data(V1p)), [(V1 +1 =< 10)], [V1p = V1], 4). % x < 10
stmtsrc(4, 'assume(x < 10);').
transition_access( 4, [r] ).
r(p(pc(main-6-5), data(V1)), p(pc(main-8-5), data(V1p)), [(V1 >= 10)], [V1p = V1], 5). % x >= 10
stmtsrc(5, 'assume(x >= 10);').
transition_access( 5, [r] ).
r(p(pc(main-4-5), data(V1)), p(pc(main-7-5), data(V1p)), [(V1 +1 =< 0)], [V1p = V1], 6). % x < 0
...
r(p(pc(main-2-8), data(V1)), p(pc(main-err-0), data(V1p)), [(V1 +1 =< 10)], [V1p = V1], 9). % x < 10
stmtsrc(9, 'assume(x < 10);').
transition_access( 9, [r] ).
r(p(pc(main-2-8), data(V1)), p(pc(main-9-9), data(V1p)), [(V1 >= 10)], [V1p = V1], 10). % x >= 10
stmtsrc(10, 'assume(x >= 10);').

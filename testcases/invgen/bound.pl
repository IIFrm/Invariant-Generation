...
cfg_exit_relation([]).
% 18 transitions
r(p(pc(main-0-4), data(V2, V1)), p(pc(main-2-4), data(V2p, V1p)), [(V1 >= 0)], [V2p = V2, V1p = V1], 1). % i >= 0
stmtsrc(1, 'assume(i >= 0);').
transition_access( 1, [_, r] ).
r(p(pc(main-2-4), data(V2, V1)), p(pc(main-4-4), data(V2p, V1p)), [(V1 =< 200)], [V2p = V2, V1p = V1], 2). % i <= 200
stmtsrc(2, 'assume(i <= 200);').
transition_access( 2, [_, r] ).
r(p(pc(main-4-4), data(V2, V1)), p(pc(main-1-4), data(V2p, V1p)), [], [V2p = 1, V1p = V1], 3). % tmp := 1
stmtsrc(3, 'tmp=1;').
transition_access( 3, [w, _] ).
r(p(pc(main-2-4), data(V2, V1)), p(pc(main-5-4), data(V2p, V1p)), [(V1 >= 1+ 200)], [V2p = V2, V1p = V1], 4). % i > 200
stmtsrc(4, 'assume(i > 200);').
transition_access( 4, [_, r] ).
r(p(pc(main-5-4), data(V2, V1)), p(pc(main-1-4), data(V2p, V1p)), [], [V2p = 0, V1p = V1], 5). % tmp := 0
stmtsrc(5, 'tmp=0;').
transition_access( 5, [w, _] ).
r(p(pc(main-0-4), data(V2, V1)), p(pc(main-3-4), data(V2p, V1p)), [(V1 +1 =< 0)], [V2p = V2, V1p = V1], 6). % i < 0
...
r(p(pc(main-9-5), data(V2, V1)), p(pc(main-10-6), data(V2p, V1p)), [(V1 >= 1+ 0)], [V2p = V2, V1p = V1], 11). % i > 0
stmtsrc(11, 'assume(i > 0);').
transition_access( 11, [_, r] ).
r(p(pc(main-9-5), data(V2, V1)), p(pc(main-11-5), data(V2p, V1p)), [(V1 =< 0)], [V2p = V2, V1p = V1], 12). % i <= 0
stmtsrc(12, 'assume(i <= 0);').
...
r(p(pc(main-7-8), data(V2, V1)), p(pc(main-err-0), data(V2p, V1p)), [(V1 +1 =< 0)], [V2p = V2, V1p = V1], 15). % i < 0
stmtsrc(15, 'assume(i < 0);').
transition_access( 15, [_, r] ).
r(p(pc(main-7-8), data(V2, V1)), p(pc(main-12-9), data(V2p, V1p)), [(V1 >= 0)], [V2p = V2, V1p = V1], 16). % i >= 0
stmtsrc(16, 'assume(i >= 0);').
transition_access( 16, [_, r] ).
r(p(pc(main-12-9), data(V2, V1)), p(pc(main-ret-0), data(V2p, V1p)), [], [V2p = V2, V1p = V1], 17). % 
stmtsrc(17, 'skip;').
transition_access( 17, [_, _] ).
r(p(pc(main-11-5), data(V2, V1)), p(pc(main-8-0), data(V2p, V1p)), [], [V2p = V2, V1p = V1], 18). % 
stmtsrc(18, 'skip;').

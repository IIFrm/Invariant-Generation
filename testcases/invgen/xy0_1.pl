...
r(p(pc(main-9-7), data(V2, V1, V4, V3)), p(pc(main-11-0), data(V2p, V1p, V4p, V3p)), [], [V2p = V2, V1p = (V1 + 1), V4p = V4, V3p = V3], 13). % x := x + 1
stmtsrc(13, 'x=x + 1;').
...
r(p(pc(main-10-8), data(V2, V1, V4, V3)), p(pc(main-13-8), data(V2p, V1p, V4p, V3p)), [(V1 = V2)], [V2p = V2, V1p = V1, V4p = V4, V3p = V3], 15). % x == y
...
r(p(pc(main-10-8), data(V2, V1, V4, V3)), p(pc(main-14-8), data(V2p, V1p, V4p, V3p)), [(V1 +1 =< V2)], [V2p = V2, V1p = V1, V4p = V4, V3p = V3], 20). % x < y
stmtsrc(20, 'assume(x < y);').
transition_access( 20, [r, r, _, _] ).
r(p(pc(main-10-8), data(V2, V1, V4, V3)), p(pc(main-14-8), data(V2p, V1p, V4p, V3p)), [(V1 >= 1+ V2)], [V2p = V2, V1p = V1, V4p = V4, V3p = V3], 21). % x > y
stmtsrc(21, 'assume(x > y);').

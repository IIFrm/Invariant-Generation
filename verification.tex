...
For example, if there is a branch in loop body such as $$if (x == 100) \cdots$$, 
our samples would hardly cover this branches except we do sampling amazing right to $(x\mapsto 10)$.
To handle this problem, program verification, as the last security checkpoint on these ``bad guys'', stands out.

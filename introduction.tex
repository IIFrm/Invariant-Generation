...
%    naturally with very light additional programming.
    ...
    and KLEE~\cite{cadar2008klee} for symbolic execution~\cite{king1976symbolic,symbolic}) and can be used as a language/platform independent tool to verify programs.

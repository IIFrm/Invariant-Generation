...
Previous research on the invariant inference mainly uses 
...
classification algorithm in machine learning~\cite{cite}, 
%concolic testing~\cite{sen2007concolic} 
symbolic execution~\cite{khurshid2003generalized}

...
Assume that the following three valuations are randomly sampled initially in our running example: $\{x \mapsto 1, y \mapsto 2\}$, $\{x \mapsto 10, y \mapsto 1\}$ and $\{x \mapsto 100, y \mapsto 0\}$. 
...
and generate new valuations $\{x \mapsto 7, y \mapsto -13\}$ and $\{x \mapsto 14, y \mapsto -11\}$ %$\{x \mapsto 44, y \mapsto -2\}$ 

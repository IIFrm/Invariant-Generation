...
Another problem with the above approach is that its effectiveness is limited by the learning algorithms adapted.
...
Secondly, we partially handle disjunctive invariants by learning at different program locations.
...
Section~\ref{sec:sampling} and~\ref{sec:learning} then presents details on two main steps in our framework: data collection and active learning. 
Section~\ref{sec:disjunctive} shows the details of our framework to handle disjunctive invariants based on program locations.

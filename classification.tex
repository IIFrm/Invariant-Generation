...
and does not violate the implication traces.
...
In fact, machine learning community has studied classification problem for years.
% \underline{the classification problem has been studied by machine learning community for years},
...
otherwise, we apply selective sampling so that we can generate additional labeled samples for refining the classifier. \LL{should be used to check the correctness?}

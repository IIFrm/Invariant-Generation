...
After getting a classifier for the current dataset, active learning technique is used to refine the guess until it gets convergence. 
...
Polynomials seems powerful in expression abilities, 
...
So in this case, we need to learn the conjunctive invariant directly, avoiding convert them into a form of polynomials.
...
In their algorithm, they take $\textsc{Svm}$ as meta linear classification algorithm, and they failed to simplify the learned classifiers.

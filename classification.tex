...
\Indm
\Indp
let $\mathit{old\_f_1}, \mathit{old\_f_2}, \mathit{old\_f_3}$ be $\textsc{null}$\;
\While{true} {
...
\end{enumerate}
\LJ{Alternatively, we can use existing equation system solvers (like GSL~\cite{gough2009gnu}) directly to find solutions for equation $-2x^2+2y = -11$. It seems GSL can not handle multivariate polynomials directly }

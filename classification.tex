...
Assume a Hoare triple that there are $n$ branches in the loop body is given, 
...
Similar procedures are adapted for other branches and the approach can generate an invariant candidate by combining all there branch invariant candidates.

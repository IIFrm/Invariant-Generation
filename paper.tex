...
If it cannot, the generated counterexample is used for re-classification and we repeat the above process. Furthermore, we show that by partitioning the program states according to program locations they visit and classify each partition separately, we are able to learn disjunctive loop invariants. We have developed a prototype tool and applied it to verify a set of benchmark programs. The evaluation shows that our approach complements existing approaches/tools in finding loop invariants in linear, polynomial, conjunctive or disjunctive forms.

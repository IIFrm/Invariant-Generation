...
\hline
\multicolumn{1}{|c|}{05~\cite{isil2013inductive}}				&linear 			& \textbf{113} & \textbf{1} &\textbf{21}	& 127 & 3  & 28	&\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{21~\cite{isil2013inductive}}				&linear 			& \textbf{187} & \textbf{2} & \textbf{21}	& to & to & to & \multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{23~\cite{isil2013inductive}}				&conjunctive		& \textbf{210} & \textbf{3} & \textbf{54}	& 280 & 4 & 55 &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{28~\cite{isil2013inductive}}				&conjunctive		& \textbf{293} & \textbf{4} &\textbf{43}	& 360 & 8 & 64 &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{30~\cite{isil2013inductive}}				&conjunctive		& \textbf{1327} & \textbf{38} & \textbf{80} & to & to & to &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{35~\cite{isil2013inductive}}				&linear 			& \textbf{147} & \textbf{1} &\textbf{19}	& to & to & to &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{43~\cite{isil2013inductive}}				&linear 			& 440 & \textbf{1} &\textbf{27}	& \textbf{320} & 4   & 37 &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{bound~\cite{isil2013inductive}}				&linear 			& 60 & \textbf{1} &\textbf{19}	& \textbf{33} & 2 & 22 &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{dillig\_35~\cite{isil2013inductive}}		&linear 			& \textbf{153} & \textbf{2} &\textbf{20}	&193 &4  & 33 &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{down~\cite{gupta2009invgen}}				&linear 			& 370 & \textbf{3} &\textbf{34}	& \textbf{320} & \textbf{5} & 40 &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{f2~\cite{}}				&linear 			& 127 & \textbf{1} &\textbf{29}	& \textbf{120} & 2 & 39 &\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{fm11~\cite{schwartznon}}	&conjunctive		& \textbf{166} & \textbf{2} &\textbf{12}	& to & to  & to	&\multicolumn{1}{|c|}{\cmark} \\
...
%
\multicolumn{1}{|c|}{zilu\_disj1}		&disjunctive		&2700 5880 4200 &3 4 6&\textbf{83.89 55.95 77.55}	&12380 5100 9020 &5 2 3  &\textbf{103.19 44.25 63.19}	&\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{zilu\_disj2}		&disjunctive		&1580 2880 5120 &5 3 3&\textbf{32.45 24.06 25.13}	&9940 3560 4160 &4 3 3 &\textbf{41.76 20.39 26.34}		&\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{zilu\_disj3}		&disjunctive		&6320 13940 6885 &3 3 3 &\textbf{24.44 33.04 30.67}	&12390 8370 15390 &3 3 3  &\textbf{54.58 23.68 43.03}	&\multicolumn{1}{|c|}{\cmark} \\
\multicolumn{1}{|c|}{pldi08~\cite{gulavani2008automatically}}&disjunctive		&- - - &- - -&\textbf{? ? ?}			&- - - &- - -  &\textbf{? ? ?}					&\multicolumn{1}{|c|}{\cmark} \\

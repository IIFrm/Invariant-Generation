...
The benchmark $f2, xy*, pldi08$ are from publications~\cite{gulwani2008program,sharma2012interpolants,gulavani2008automatically}. The benchmark $interproc*$ are from~\cite{jeannet2010interproc}.
The benchmark $zilu\_*$ are constructed by ourselves. The benchmark $terminator\_01\_safe$ is gathered from~\cite{beyer:SVCOMP:2013} and the others are collected from the software verification competition repository~\cite{Dirk:SVCOMP:2016}. All benchmarks are available from~\cite{zilu:benchmark}.
%% Note
...
We manually check the generated invariants for correctness. CPAChecker (formerly BLAST~\cite{henzinger2003software}) is a software verification tool. In the experiments, CPAChecker is configured to generate loop invariants to prove the same Hoare triple. We remark that the comparison should be taken with a grain of salt as the methods are different. In addition, we measure the performance of \textsc{Zilu} with or without selective sampling in order to show its relevance.
...
%\hline
\multicolumn{1}{|c|}{f2}         						&linear 		&260 &1 &\textbf{10.15}  		&120 &1   &12.03  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{xy10} 	        					&linear 		&810 &4 &\textbf{39.69} 		&840  &11  &40.51  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{xyz}   	      					&linear 		&180 &1 &105.15  				&330  &5  &\textbf{93.04}  	&\cmark &\cmark  \\
\multicolumn{1}{|c|}{xy0\_1}         					&conjunction 	&1140 &20 &\textbf{51.07}		&1980 &48 &168.97  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{xy0\_2}         					&conjunction 	&180  &2 &16.09					&260 &6 &\textbf{15.98}  	&\cmark &\cmark  \\
\multicolumn{1}{|c|}{pldi08} 		        			&disjunction 	&500 &1 &timeout  				&120  &2  &timeout  		&\xmark &\cmark  \\

%\hline
\multicolumn{1}{|c|}{interproc1}         				&linear 		&40 &1 &\textbf{9.21}  			&40 &2   &10.38  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{interproc2}         				&linear 		&600 &1 &\textbf{11.66} 		&240  &1  &171.14  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{interproc3}         				&linear 		&210 &1 &\textbf{30.32}  		&420 &5   &43.34  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{interproc4}         				&linear 		&140 &4 &\textbf{4.8}  			&240 &5   &38.25  			&\xmark &\xmark  \\
\multicolumn{1}{|c|}{interproc5}         				&linear 		&160 &1 &\textbf{9.18}  		&180 &3   &28.05  			&\cmark &\cmark  \\

%\hline
\multicolumn{1}{|c|}{zilu\_linear1}         			&linear 		&120 &2 &\textbf{24.79}  		&180 &2   &206.07  			&\xmark &\cmark  \\
\multicolumn{1}{|c|}{zilu\_linear2}         			&linear 		&420 &4 &\textbf{21.28}  		&720  &9  &82.24  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{zilu\_linear3}         			&linear 		&90 &1 &\textbf{16.19}  		&270 &3  &179.39  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{zilu\_linear4}         			&linear 		&140 &1 &\textbf{10.19}  		&420 &2  &24.51  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{zilu\_linear5}         			&linear 		&30 &1 &\textbf{8.57}  			&60 &3   &12.58  			&\cmark &\cmark  \\

\multicolumn{1}{|c|}{zilu\_poly1}         				&polynomial 	&50 &2 &\textbf{20.48}			&70 &1 &28.48  				&\xmark &\cmark  \\
\multicolumn{1}{|c|}{zilu\_poly2}         				&polynomial 	&110  &1 &\textbf{24.27}  		&70   &2 &41.62  			&\xmark &\cmark  \\
\multicolumn{1}{|c|}{zilu\_poly3}         				&polynomial 	&30 &1 &\textbf{11.83}  		&70  &2  &18.27  			&\xmark &\xmark  \\
\multicolumn{1}{|c|}{zilu\_poly4}         				&polynomial 	&1500 &5 &timeout  				&560  &2  &timeout 			&\xmark &\xmark \\
\multicolumn{1}{|c|}{zilu\_poly5}         				&polynomial 	&3400 &14 &timeout  			&800  &12  &timeout  		&\xmark &\cmark  \\
\multicolumn{1}{|c|}{zilu\_poly6}         				&polynomial 	&300 &4 &\textbf{85.61}  		&620   &12 &472.68  		&\xmark &\xmark  \\

\multicolumn{1}{|c|}{zilu\_conj1}         				&conjunction 	&120 &6 &\textbf{22.13}  		&220  &2  &97.47  			&\xmark &\cmark  \\
\multicolumn{1}{|c|}{zilu\_conj2}         				&conjunction 	&280 &3 &\textbf{173.09}  		&280  &7  &timeout  		&\cmark &\cmark  \\

%\hline
\multicolumn{1}{|c|}{terminator\_01\_safe}         		&linear 		&30 &1 &\textbf{9.2}  			&90  &4  &13.06  			&\cmark &\cmark  \\
%\hline
\multicolumn{1}{|c|}{afnp2014\_true}         			&conjunction	&1240 &27 &\textbf{39.33}		&5160 &129 &timeout  		&\xmark &\cmark  \\
\multicolumn{1}{|c|}{multivar\_true\_1}         		&conjunction 	&340 &3 &16.84  				&220 &4   &\textbf{15.22}  	&\cmark &\cmark  \\
\multicolumn{1}{|c|}{cggmp2005\_variant}   				&conjunction 	&1020 &13 &\textbf{108.57}		&1620 &24 &timeout  		&\cmark &\cmark  \\
\multicolumn{1}{|c|}{css2003\_true}         			&conjunction 	&1420 &33 &\textbf{57.78}		&5080 &125 &258.65  		&\cmark &\cmark  \\
\multicolumn{1}{|c|}{up\_true\_2}         				&conjunction 	&1200 &14 &\textbf{84.02}  		&540 &7   &89.77  			&\cmark &\cmark  \\
\multicolumn{1}{|c|}{down\_true\_1}         			&conjunction 	&1320  &15 &\textbf{116.21}  	&1770  &27  &timeout  		&\cmark &\cmark  \\
\multicolumn{1}{|c|}{down\_true\_2}         			&conjunction 	&1110 &14 &52.96  				&720 &10   &\textbf{44.99}  &\cmark &\cmark  \\
...
The last two columns show the result of Interproc and CPAChecker, i.e., whether it generates a correct invariant. We do not show the time of Interproc because its result may not be correct.
...
This is particularly useful if the loop body is beyond the capability of existing program verifiers. In such a case, \textsc{Zilu} would generate an invariant which can be used to manually verify the program, which is impossible without selective sampling.

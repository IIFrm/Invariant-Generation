...
\multicolumn{1}{|c|}{bound~\cite{isil2013inductive}}				&linear 			& 60 & \textbf{1} &\textbf{19}	& \textbf{33} & 2 & 22 &\multicolumn{1}{|c|}{\cmark} & \\
...
\multicolumn{1}{|c|}{terminator\_01~\cite{beyer:SVCOMP:2013}}	&linear 			&\textbf{37} & \textbf{1} &\textbf{19}	& 40 & 2  & 22		&\multicolumn{1}{|c|}{\cmark} & 2 \\
...
\multicolumn{1}{|c|}{zilu\_disj3}		&disjunctive		&6320 13940 6885 &3 3 3 &\textbf{24.44 33.04 30.67}	&12390 8370 15390 &3 3 3  &\textbf{54.58 23.68 43.03}	&\multicolumn{1}{|c|}{\cmark} & \ding{55} \ding{55} \\
\multicolumn{1}{|c|}{pldi08~\cite{gulavani2008automatically}}&disjunctive		&- - - &- - -&\textbf{? ? ?}			&- - - &- - -  &\textbf{? ? ?}					&\multicolumn{1}{|c|}{\cmark} &  \ding{55}\\
\multicolumn{1}{|c|}{popl~\cite{sharma2011simplifying}}		&disjunctive		&- - - &- - -&\textbf{? ? ?}			&- - - &- - -  &\textbf{? ? ?}					&\multicolumn{1}{|c|}{\cmark} & \\
\multicolumn{1}{|c|}{cav~\cite{sharma2011simplifying}}		&disjunctive		&- - - &- - -&\textbf{? ? ?}			&- - - &- - -  &\textbf{? ? ?}					&\multicolumn{1}{|c|}{\cmark} & \\

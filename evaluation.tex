...
For example, assume a program with an integer variable $x$ which can be any value in set $\{\cdots, -1, 0,  1, 2, 3, \cdots\}$. 
However $(x, x^2)$ is defined only in \{$\cdots, (-1,1), (0,0), (1,1), (2, 4), (3, 9) \cdots$\} after mapping. 

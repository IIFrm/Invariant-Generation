...
\hline
No. of programs proved 			& ??? & ???		\\
Average time for proving a program & ??? & ???  			\\
Average number of guess-and-check iterations & ??? & ???  			\\
No. of programs proved with one guess-and-check iteration & ??? & ???		\\
Average number of total samples & ??? & ???  			\\
\hline
\end{tabular}
\label{summary}
\end{table}
...
\hline
\multicolumn{1}{|c|}{14 programs} & linear inequality 			& 107 & \textbf{1} &\textbf{4}	& \textbf{100} & 2 & \textbf{4} 	\\
\multicolumn{1}{|c|}{5 programs} & polynomial inequality			& 107 & \textbf{1} &\textbf{4}	& \textbf{100} & 2 & \textbf{4} 	\\
\multicolumn{1}{|c|}{11 programs} & conjunction of linear inequalities 			& 107 & \textbf{1} &\textbf{4}	& \textbf{100} & 2 & \textbf{4} 	\\
\multicolumn{1}{|c|}{5 programs} & disjunction of linear inequalities 			& 107 & \textbf{1} &\textbf{4}	& \textbf{100} & 2 & \textbf{4} 	\\
\hline
\end{tabular}
\label{tbl:stats}
\end{table}
...
The second research question which we would like to answer is whether \textsc{Zilu} can outperform existing program verification tools on verifying these programs. Ideally, we would like to compare with those guess-and-check implementations reported in~\cite{sharma2012interpolants,sharma2013verification,DBLP:conf/esop/0001GHALN13,sharma2014invariant}. Unfortunately, those 

...
\hline
\multicolumn{1}{|c|}{benchmark}&\multicolumn{1}{|c|}{inv type} & Interproc & CPAChecker &BLAST &InvGen & Hola   \\
\hline
\multicolumn{1}{|c|}{05~\cite{isil2013inductive}}				&linear 			& \cmark & to 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{21~\cite{isil2013inductive}}				&linear 			& \xmark & \xmark 		& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{23~\cite{isil2013inductive}}				&conjunctive		& \xmark & to 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{28~\cite{isil2013inductive}}				&conjunctive		& \cmark & to 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{30~\cite{isil2013inductive}}				&conjunctive		& \xmark & 4 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{35~\cite{isil2013inductive}}				&linear 			& \cmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{43~\cite{isil2013inductive}}				&linear 			& \cmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{bound~\cite{isil2013inductive}}			&linear 			& \cmark & 3 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{down~\cite{gupta2009invgen}}				&linear 			& \cmark & to 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{f2~\cite{zilu:repo}}						&linear 			& \cmark & \xmark 		& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{fig1b}										&disjunctive		& \xmark & 1 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{fm11~\cite{schwartznon}}					&conjunctive		& \cmark & 1 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{interproc1~\cite{jeannet2010interproc}}	&linear 			& \cmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{interproc2~\cite{jeannet2010interproc}}	&linear 			& \cmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{interproc3~\cite{jeannet2010interproc}}	&linear 			& \cmark & \xmark 		& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{interproc4~\cite{jeannet2010interproc}}	&linear 			& \xmark & \xmark 		& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{multivar\_1~\cite{jeannet2010interproc}}	&conjunctive		& \cmark & 2 			& \xmark  & \xmark  & \xmark \\

\multicolumn{1}{|c|}{pldi08\_fig1~\cite{gulavani2008automatically}}&disjunctive		& \xmark &  \xmark		& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{pldi08\_fig7~\cite{gulavani2008automatically}}	&linear 		& \cmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{terminator\_01~\cite{Dirk:SVCOMP:2016}}	&linear 			& \cmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{up\_true\_2~\cite{Dirk:SVCOMP:2016}}		&conjunctive		& \cmark & to 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{xle10~\cite{sharma2012interpolants}}		&linear 			& \cmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{xy0\_1~\cite{sharma2012interpolants}}		&conjunctive		& \cmark & to 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{xy0\_2~\cite{sharma2012interpolants}}		&conjunctive		& \cmark & to 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{xy4\_1~\cite{sharma2012interpolants}}		&conjunctive		& \cmark & to 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{xyle0~\cite{sharma2012interpolants}}		&polynomial 		& \xmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{xyz\_2~\cite{sharma2012interpolants}}		&conjunctive		& \cmark & \xmark		& \xmark  & \xmark  & \xmark \\

\multicolumn{1}{|c|}{zilu\_conj1}								&conjunctive		& \xmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{zilu\_disj1}								&disjunctive		& \cmark & \xmark 		& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{zilu\_disj2}								&disjunctive		& \xmark & \xmark 		& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{zilu\_disj3}								&disjunctive		& \xmark & \xmark 		& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{zilu\_poly1}								&polynomial			& \xmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{zilu\_poly3}								&polynomial			& \xmark & 2 			& \xmark  & \xmark  & \xmark \\
\multicolumn{1}{|c|}{zilu\_poly6}								&polynomial			& \xmark & \xmark 		& \xmark  & \xmark  & \xmark \\
\hline
\end{tabular}
\label{tbl:stats2}
\end{table}
